...
export const BloggerCard = forwardRef<HTMLDivElement, BloggerCardProps>(function BloggerCard(
	{ blogger, index = 0, stagger = true, isEditMode = false, onUpdate, onDelete },
	ref
) {
	...
	return (
		<motion.div
			...
			className='card glass-standard relative block overflow-hidden rounded-[var(--radius-card)]'>
			{isEditMode && (
