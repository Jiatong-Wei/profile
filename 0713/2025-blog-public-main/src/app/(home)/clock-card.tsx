...
export default function ClockCard() {
	...
	const y = styles.offsetY !== null ? center.y + styles.offsetY : snapToHomeGrid(center.y - styles.offset - styles.height)

	return (
		<HomeDraggableLayer cardKey='clockCard' x={x} y={y} width={styles.width} height={styles.height}>
			<Card cardKey='clockCard' glassTone='quiet' motionRole='pressable' order={styles.order} width={styles.width} height={styles.height} x={x} y={y} className='p-2'>
				{siteContent.enableChristmas && (
					<>
						<img
							src={withSiteBase('/images/christmas/snow-5.webp')}
							alt='Christmas decoration'
							className='pointer-events-none absolute'
							style={{ width: 60, left: 2, bottom: 2, opacity: 0.6 }}
						/>
						<img
							src={withSiteBase('/images/christmas/snow-6.webp')}
							alt='Christmas decoration'
							className='pointer-events-none absolute'
