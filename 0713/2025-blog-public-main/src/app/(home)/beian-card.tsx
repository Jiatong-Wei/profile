...
export default function BeianCard() {
	...
	const x = styles.offsetX !== null ? center.x + styles.offsetX : snapToHomeGrid(center.x + hiCardStyles.width / 2 - styles.width + 200)
	const y = styles.offsetY !== null ? center.y + styles.offsetY : snapToHomeGrid(center.y + hiCardStyles.height / 2 + CARD_SPACING + 180)
