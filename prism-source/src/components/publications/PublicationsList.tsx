        ...
        >
            ...
            <div className="space-y-6">
                {filteredPublications.length === 0 ? (
                    publications.length === 0 ? (
                        <div className="rounded-2xl border border-neutral-200/80 dark:border-neutral-700/70 bg-white/70 dark:bg-neutral-900/55 p-10 md:p-14 shadow-sm text-center">
                            <p className="text-2xl md:text-3xl font-serif font-semibold tracking-tight text-primary">
                                Papers are coming.
                            </p>
                        </div>
                    ) : (
